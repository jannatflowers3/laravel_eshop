...
<div class="box span12">
    ...
    <div class="box-content">
        <form class="form-horizontal" action="{{url('/subcategories')}}" 
        ...
        {{ method_field('POST') }}
            ...
            <fieldset>
                ...
                <div class="control-group">
                    <label class="control-label" for="name">SubCategory </label>
                    <div class="controls">
                ...
                <div class="control-group">
                    <label class="control-label" for="name">SubCategory Name</label>
                    <div class="controls">
